...
class QuikConnectorTest(JsonProtocolHandler):
    ...
    def subscribeParams(self):
        self.msgId += 1
        self.sendReq(self.msgId, {"method": "subscribeParamChanges", "class": "SPBFUT", "security": "SiH3", "param": "BID"})
        self.paramsReqId = self.msgId
